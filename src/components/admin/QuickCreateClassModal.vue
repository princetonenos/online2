...
function create(){
  const payload = { id: Date.now().toString(), title: form.title || 'Untitled', startAt: form.startAt || new Date().toISOString(), duration: form.duration, level: form.level, status: 'scheduled' }
